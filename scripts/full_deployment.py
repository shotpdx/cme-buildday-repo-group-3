...
4. Runs the Buyside Data Foundation pipeline (creates gold tables)
5. Sets up Genie Space for Ask AI
6. Sets up Vector Search for asset search
7. Uploads creative assets (images, videos)
8. Builds and deploys the Databricks App
...
SEED_IMAGES = MY_PROJECT / "creative_demo_assets" / "seed_images"
VIDEO_SEEDS = MY_PROJECT / "creative_demo_assets" / "video_seeds"
...
def create_uc_resources():
    ...
    sql_commands = [
        ...
        f"CREATE SCHEMA IF NOT EXISTS {CATALOG}.{SOURCE_SCHEMA}",
        f"CREATE VOLUME IF NOT EXISTS {CATALOG}.{SCHEMA}.artifacts",
        f"CREATE VOLUME IF NOT EXISTS {CATALOG}.{SCHEMA}.seed_data",
    ]
...
def run_buyside_pipeline():
    ...
    step_header(4, "Running Buyside Data Foundation Pipeline")
...
def setup_genie_space():
    ...
    step_header(5, "Setting Up Genie Space")
...
def setup_vector_search():
    ...
    step_header(6, "Setting Up Vector Search")
...
def upload_creative_assets():
    ...
    step_header(7, "Uploading Creative Assets to UC Volume")
...
def build_frontend():
    ...
    step_header(8, "Building Frontend")
...
def deploy_app():
    ...
    step_header(9, "Deploying Databricks App")
...
def verify_deployment():
    ...
    step_header(10, "Verifying Deployment")
...
def main():
    ...
    ║  3. Run Bronze/Silver/Gold pipelines                              ║
